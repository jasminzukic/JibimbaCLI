...
/* package JibimaCLI-0.1.0.0 */
#ifndef VERSION_JibimaCLI
#define VERSION_JibimaCLI "0.1.0.0"
#endif /* VERSION_JibimaCLI */
#ifndef MIN_VERSION_JibimaCLI
#define MIN_VERSION_JibimaCLI(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_JibimaCLI */

/* package ansi-terminal-0.8.0.2 */
#ifndef VERSION_ansi_terminal
#define VERSION_ansi_terminal "0.8.0.2"
...
#define CURRENT_COMPONENT_ID "JibimaCLI-0.1.0.0-BwQQpHPBgWUB5i2WhQzbdJ-JibimaCLI"
